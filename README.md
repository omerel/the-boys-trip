...
האתר מחייב כניסה עם Google והגישה לנתונים מוגבלת בכללי Firestore לשלושת החשבונות שאושרו. כתובות הדוא״ל האמיתיות מוגדרות ישירות ב־Firebase Console ואינן נשמרות במאגר הקוד הציבורי. פרטי הלו״ז וההערות נשמרים ב־Firestore ומתקבלים רק לאחר אימות והרשאה.
